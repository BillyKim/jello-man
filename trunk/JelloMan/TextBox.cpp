...
void TextBox::SetText(tstring const& text)
{
	SendMessage(m_hWndEdit, WM_SETTEXT, 0, (LPARAM) text.c_str());
}

void TextBox::SetFont(tstring const& fontName, bool bold, bool italic, bool underline, int size)
{
	LOGFONT ft;
