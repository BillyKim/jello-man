...
LightInfo::LightInfo()	:	m_bClick(false),
...
// GENERAL
void LightInfo::Tick(const RenderContext* pRenderContext)
{
...
// GETTERS
int LightInfo::GetNrLightsSelected()
{
	int b = 0;
...
int LightInfo::GetTotalLightsInScene()
{
	if (m_pRenderContext)
